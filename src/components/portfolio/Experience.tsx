...
const experienceData = [
  {
    ...
    highlights: [
      ...
      "Developed CRUD functionalities and integrated backend APIs with angular frontend modules.",
      "Optimized MongoDB queries and improved application performance for large datasets.",
      "Integrated third-party APIs and external business services into enterprise applications.",
      ...
      "Collaborated with QA, UI/UX, and DevOps teams for smooth deployments and delivery cycles.",
