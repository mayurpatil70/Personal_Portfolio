...
const experienceData = [
  {
    ...
    type: "Full-time",
    highlights: [
      "Developed enterprise-grade web applications using C#, ASP.NET Core, Angular, and SQL Server",
      "Designed responsive front-end modules using Angular, HTML5, CSS3, and TypeScript.",
      "Built scalable REST APIs for internal and client-facing systems.",
      "Implemented CRUD operations, authentication, and role-based access modules.",
      "Optimized SQL Server queries, stored procedures, and database performance.",
      "Integrated third-party APIs and internal business services.",
      "Performed debugging, issue resolution, and production support activities.",
      ...
      "Maintained code quality using Git version control and peer reviews",
    ],
  },
  // {
  //   id: 2,
